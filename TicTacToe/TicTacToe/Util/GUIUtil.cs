...
namespace TicTacToe.Util
{
    public static class GUIUtil
    {
        ...
        public static void DrawLine(this SpriteBatch spriteBatch, Texture2D texture, Vector2 start, Vector2 end, Color color)
        {
            spriteBatch.Draw(texture, start, null, color, (float)Math.Atan2(end.Y - start.Y, end.X - start.X),
                new Vector2(0.0f, (float)texture.Height / 2),
                new Vector2(Vector2.Distance(start, end), 1.0f),
                SpriteEffects.None, 0.0f);
        }
